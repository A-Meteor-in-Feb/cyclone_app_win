...
int run_publisher_application(int tele_id) {
    ...
    dds::topic::Topic<TeleData::steeringWheel_data> steeringWheel_topic(control_participant, "steeringWheel_topic");
    dds::topic::Topic<TeleData::joyStick_data> joyStick_topic(control_participant, "joyStick_topic");
